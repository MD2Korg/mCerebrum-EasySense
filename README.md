...
This Android application integrates the EasySense platform into mCerebrum's data collection and processing system.
...
For the versions available, see [this repository's tags](https://github.com/MD2Korg/mCerebrum-EaseSense/tags).

## Contributors

Link to the [list of contributors](https://github.com/MD2Korg/mCerebrum-EasySense/graphs/contributors) who participated in this project.
