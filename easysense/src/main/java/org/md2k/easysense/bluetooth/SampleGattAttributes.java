...
public class SampleGattAttributes {
    ...
    public static final UUID AUTOSENSE_SERVICE_UUID = UUID.fromString("0000180a-0000-1000-8000-00805f9b34fb");
    ...
    public static final UUID EASYSENSE_SERVICE_UUID = UUID.fromString("0000180a-0000-1000-8000-00805f9b34fb");
